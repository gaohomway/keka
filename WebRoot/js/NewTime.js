function Dsy() {
	...
	dsy.add("0", [ "北京", "上海", "天津", "重庆", "广东", "广西", "贵州", "海南", "河北", "河南",
			...
			"山西", "陕西", "上海", "四川", "天津", "西藏", "新疆", "云南", "浙江", "甘肃", "安徽",
			"福建" ]);

	dsy.add("0_0", [ "北京" ]);
	dsy.add("0_0_0", [ "北京市", "东城区", "西城区", "宣武区", "房山区", "崇文区", "海淀区", "朝阳区",
			"丰台区", " 门头沟区", "石景山区", "通州区", "顺义区", "昌平区", "大兴区", "怀柔区", "平谷区",
			"密云县", "延庆县" ]);
	...
	dsy.add("0_11", [ "武汉", "恩施土家族苗族自治州", "黄冈", "黄石", "荆门", "荆州", "潜江",
			"神农架林区", "十堰", "随州", "天门", "鄂州", "仙桃", "咸宁", "襄樊", "孝感", "宜昌" ]);
	dsy.add("0_11_0", [ "江汉区", "江岸区", "桥口区", "汉阳区", "武昌区", "青山区", "洪山区",
			"东西湖区", "江夏区", "新洲区", "黄陂区", "汉南区", "蔡甸区" ]);
	dsy.add("0_11_1",
	...
	dsy.add("0_30", [ "白银", "定西", "甘南藏族自治州", "嘉峪关", "金昌", "酒泉", "兰州",
	...
	dsy.add("0_30_5", [ "阿克塞哈萨克族自治县", "安西县", "敦煌市", "金塔县", "酒泉市", "肃北蒙古族自治县",
			"玉门市" ]);
	dsy.add("0_30_6", [ "皋兰县", "兰州市", "永登县", "榆中县" ]);
	dsy.add("0_30_7", [ "东乡族自治县", "广河县", "和政县", "积石山保安族东乡族撒拉族自治县", "康乐县",
			"临夏市", "临夏县", "永靖县" ]);
	dsy.add("0_30_8", [ "成县", "徽县", "康县", "礼县", "两当县", "文县", "武都县", "西和县",
			"宕昌县" ]);
	dsy.add("0_30_9", [ "崇信县", "华亭县", "静宁县", "灵台县", "平凉市", "庄浪县", "泾川县" ]);
	dsy
			.add("0_30_10", [ "合水县", "华池县", "环县", "宁县", "庆城县", "庆阳市", "镇原县",
					"正宁县" ]);
	...
	dsy.add("0_31", [ "安庆", "蚌埠", "巢湖", "池州", "滁州", "阜阳", "合肥", "淮北", "淮南",
