...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            ['FontFamily', 'FontSize', 'Bold', 'Italic', 'Underline', 'ForeColor', 'BackColor', 'RemoveFormat', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'Emotion', 'Undo', 'Redo', 'Help']
        ]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{
            'fontfamily':'字体类型','fontsize':'字体大小','bold':'加粗','italic':'斜体','underline':'下划线','forecolor':'文字颜色','backcolor':'背景颜色','removeformat':'清除格式','justifyleft':'居左对齐','justifycenter':'居中对齐','justifyright':'居右对齐','emotion':'插入表情','undo':'撤销','redo':'重做','help':'帮助'
        }
