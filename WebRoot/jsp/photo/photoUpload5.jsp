...
<html>
  <head>
    <base href="<%=basePath%>">
	<title>HTML5的多图上传</title>
	<script src="keekan/js/jquery/jquery-1.7.2.min.js"></script>
	<script src="keekan/js/photo/zxxFile.js"></script>
	<link rel="stylesheet" href="keekan/css/photo/photoUpload5.css" type="text/css" />
</head>
